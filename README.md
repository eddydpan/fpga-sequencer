...
**Tetris Audio Demo:** Our sequencer playing the Tetris theme song.
...
The GUI will automatically parse and visualize the data. Use the serial port selector to connect to `/dev/ttyUSB0` or similar. The `SequencerModel` and `UARTParser` are hardware-agnostic and ready for integration.
...
https://github.com/eddydpan/fpga-sequencer
